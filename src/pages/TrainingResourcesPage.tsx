...
import { Grid, Column, Heading, Section, Button, Tabs, TabList, Tab, TabPanels, TabPanel, CodeSnippet, Accordion, AccordionItem } from "@carbon/react";
import { Document, Download, PresentationFile, Education, Terminal, Code, CheckmarkFilled } from "@carbon/icons-react";
  ...
  return (
    <Grid fullWidth className="page-container">
      <Column lg={16} md={8} sm={4}>
        ...
        {/* Tabs for Resources and Training Plan */}
        <Tabs selectedIndex={selectedTab} onChange={(e) => setSelectedTab(e.selectedIndex)}>
          <TabList aria-label="Training resources tabs" contained>
            <Tab>Resources</Tab>
            <Tab>Comprehensive Training Plan</Tab>
          </TabList>
          ...
          <TabPanels>
            ...
            <TabPanel>
              {/* Philosophy Section */}
              <Section level={3} style={{ marginTop: "2rem", marginBottom: "3rem" }}>
                <div style={{ 
            ...
            {/* Tab 2: Comprehensive Training Plan */}
            <TabPanel>
              <Section level={3} style={{ marginTop: "2rem", marginBottom: "2rem" }}>
                <div style={{ 
                  backgroundColor: "#e8f4ff", 
                  padding: "2rem", 
                  borderRadius: "8px",
                  ...
                  <p style={{ color: "#161616", lineHeight: 1.8, margin: 0 }}>
                    This training plan is designed for a mixed audience, covering terminal fundamentals from beginner 
                    to intermediate level. Whether you're new to the command line or looking to strengthen your skills, 
                    this guide provides a structured learning path with hands-on exercises.
                  </p>
                </div>
                ...
                <div style={{ 
                  ...
                  <h3 style={{ marginTop: 0, marginBottom: "1.5rem" }}>Learning Path</h3>
                  <div style={{ fontFamily: "monospace", fontSize: "0.875rem", color: "#161616", lineHeight: 1.8 }}>
                    <div>Terminal Apps → Understanding Shells</div>
                    <div>Understanding Shells → Text Editors</div>
                    <div>Text Editors → Filesystem Navigation</div>
                    <div>Filesystem Navigation → Redirection & Pipes</div>
                    <div>Redirection & Pipes → Advanced Topics</div>
                    <div>Advanced Topics → Practical Mastery</div>
                  </div>
                </div>
...
chown user:group file.txt`}
                ...
                <div style={{ 
                  ...
                  <p style={{ margin: "0.5rem 0 0 0", color: "#525252", fontSize: "0.875rem" }}>
                    For the complete 1,988-line guide, <Button kind="ghost" size="sm" onClick={() => window.open('/terminal-basics/terminal-training-plan.html', '_blank')}>view the HTML version</Button>
                  </p>
                </div>
              </Section>
            </TabPanel>
